...
Serveur::Serveur()
{
    ...
    if (!serveur->listen(QHostAddress::Any, 30818)) // Démarrage du serveur sur toutes les IP disponibles et sur le port 50585
    {
...
void Serveur::donneesRecues()
{
    ...
    message.insert(0,"<strong>Le message inversé :</strong> ");
